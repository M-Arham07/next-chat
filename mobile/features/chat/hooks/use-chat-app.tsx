...
export const useChatAppHook = (): ChatAppHook => {
...
export const useChatApp = (): ChatAppHook => {
...
// Provider component
export const ChatAppProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
