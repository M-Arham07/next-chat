...
export default function MessagesViewClient({ threadId }: { threadId: string }) {
    ...
    const { messages, replyingToMsg, handleSendMessage, selectedThreadId, handleTyping, set, addMessages, threads, typingUsers } = useChatApp()!;
    ...
    useInfiniteScroll(sentinelRef, mainRef, mounted, setLoadingState);
